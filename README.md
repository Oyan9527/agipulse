...
功能：24H 信息密度频谱（√缩放）、数据看板（信号量/精选率/信源健康/多源确认）、**日/周/月三维度**分类动量与趋势关键词、头条大字号展示、热点雷达（多源确认×新鲜度）、今日简报、英文标题自动附中文译文、精选分类配额（论文≤10、开源项目保底5）、命令面板搜索（Ctrl/Cmd+K）。界面为中文报纸头版风格：米白纸面、衬线大刊头、朱红强调色、细线分栏。
