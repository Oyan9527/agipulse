...
同时给出 category（必须是给定列表之一）和 reason_zh（一句话中文推荐理由，不超过40字）。
返回 JSON: {{"results": [{{"id": "...", "source_authority": 0.0, "novelty": 0.0, "impact": 0.0, "practical_value": 0.0, "category": "...", "reason_zh": "..."}}]}}
必须覆盖所有输入的 id。"""
